//*****************************************************************************
//
// aes_ecb_encrypt.c - Simple AES128 ECB encryption demo.
//
...
//! <h1>AES128 and AES256 ECB Encryption Demo (aes_ecb_encrypt)</h1>
//!
//! Simple demo showing an encryption operation using the AES128 and AES256
//! modules in ECB mode.  A single block of data is encrypted.
//!
