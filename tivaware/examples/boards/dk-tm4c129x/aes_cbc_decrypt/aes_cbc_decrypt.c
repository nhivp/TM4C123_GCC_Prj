//*****************************************************************************
//
// aes_cbc_decrypt.c - Simple AES128 and AES256 CBC decryption demo.
//
...
//! <h1>AES CBC Decryption Demo (aes_cbc_decrypt)</h1>
//!
//! Simple demo showing an decryption operation using the AES128 and AES256
//! modules in CBC mode.  A number of blocks of data are decrypted.
//!
...
//*****************************************************************************
bool
AESCBCDecrypt(uint32_t ui32Keysize, uint32_t *pui32Src, uint32_t *pui32Dst,
...
//*****************************************************************************
//
// This example decrypts blocks of plaintext using AES128 and AES256 in CBC
...
main(void)
{
    ...
    //
    FrameDraw(&sContext, "aes-cbc-decrypt");
    ...
    //
    ConfigureUART();
    UARTprintf("Starting AES CBC decryption demo.\n");
