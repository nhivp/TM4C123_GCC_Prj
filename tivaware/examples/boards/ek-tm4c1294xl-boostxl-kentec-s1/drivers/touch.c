//*****************************************************************************
//
// touch.c - Touch screen driver for the EK-TM4C1294XL board.
//
...
#define TS_XP_PIN               GPIO_PIN_5//U
#define TS_XP_ADC               ADC_CTL_CH11
#define TS_YP_PIN               GPIO_PIN_4//R
#define TS_YP_ADC               ADC_CTL_CH10
#define TS_XN_PERIPH            SYSCTL_PERIPH_GPIOK
#define TS_XN_BASE              GPIO_PORTK_BASE
#define TS_XN_PIN               GPIO_PIN_7//L
#define TS_YN_PERIPH            SYSCTL_PERIPH_GPIOM
#define TS_YN_BASE              GPIO_PORTM_BASE
